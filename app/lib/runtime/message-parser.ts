...
const ARTIFACT_TAG_OPEN = '<liblabArtifact';
...
export interface ArtifactCallbackData extends LiblabArtifactData {
  messageId: string;
}
...
interface MessageState {
  ...
  currentArtifact?: LiblabArtifactData;
  currentAction: LiblabActionData;
  actionId: number;
}
