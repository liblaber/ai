...
export const QueryModal = memo(
  ({ isOpen, onOpenChange, queryId, onUpdateAndRegenerate, dataSourceId }: QueryModalProps) => {
    ...
    const handleGenerateSql = async (dataSourceId: string) => {
      ...
      try {
        ...
        const response = await fetch('/api/generate-query', {
          ...
          body: JSON.stringify({ prompt: userPrompt, existingQuery: query, dataSourceId }),
        });
