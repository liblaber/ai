    ...
    <AnimatePresence>
      ...
      >
        <div className="flex items-start">
          ...
          >
            <div className={`i-ph:warning-duotone text-xl text-liblab-elements-button-danger-text`}></div>
          </motion.div>
          {/* Content */}
              ...
              <div className={classNames(' flex gap-2')}>
                <button
                  ...
                  className={classNames(
                    ...
                    'bg-accent-500',
                    'hover:bg-accent-700',
                    'focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-liblab-elements-button-danger-background',
                    'text-liblab-elements-button-primary-text',
                ...
                <button
                  ...
                  className={classNames(
                    `px-2 py-1.5 rounded-md text-sm font-medium`,
                    'bg-liblab-elements-button-secondary-background',
                    'hover:bg-liblab-elements-button-secondary-backgroundHover',
                    'focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-liblab-elements-button-secondary-background',
                    'text-liblab-elements-button-secondary-text',
                  )}
                >
                  Dismiss
                </button>
