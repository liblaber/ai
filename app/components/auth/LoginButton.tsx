    ...
    <DialogRoot open={isLoginModalOpen} onOpenChange={toggleLoginModal}>
      ...
      >
        <div className="w-full flex flex-col items-center justify-center">
          <h2 className="text-center text-lg font-medium mb-12 mt-0 text-liblab-elements-textPrimary">
            {loginModalTitle || 'Log in'}
          </h2>
          <div className="px-6 w-full" onClick={handleGoogleLogin}>
            <button className="gsi-material-button" style={{ width: '300px' }}>
