import type { GitHubContent, GitHubRepoInfo, RepositoryStats } from '~/types/GitHub';
            ...
            {activeTab === 'url' ? (
              <div className="space-y-4">
                ...
                <button
                  ...
                  disabled={!customUrl}
                  className="w-full h-10 px-4 py-2 rounded-lg bg-accent-500 text-white hover:bg-accent-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center gap-2 justify-center"
                >
                  Import Repository
                </button>
              </div>
              ...
              <>
                ...
                <div className="space-y-3 max-h-[400px] overflow-y-auto scrollbar-thin pr-2 custom-scrollbar">
                  {selectedRepository ? (
                    <div className="space-y-4">
                      <div className="flex items-center gap-2">
                        <button
