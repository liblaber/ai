...
export default function EnvironmentsTab() {
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button
              data-testid="back-button-create"
              onClick={handleBack}
  ...
  if (showAddAccessForm && selectedEnvironment) {
    return (
      <AddResourceAccess
      ...
      <div className="space-y-4">
        {environments.length === 0 ? (
          ...
          environments.map((environment) => (
            <motion.div
              key={environment.id}
              data-testid={`environment-item-${environment.id}`}
            ...
            >
              <div className="w-full flex items-center justify-between p-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    data-testid={`edit-environment-${environment.id}`}
                  ...
                  <button
                    data-testid={`delete-environment-${environment.id}`}
