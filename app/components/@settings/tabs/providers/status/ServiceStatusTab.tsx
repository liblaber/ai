...
import { TbActivityHeartbeat, TbBrain } from 'react-icons/tb';
      ...
      >
        <div className="flex items-center justify-between gap-2 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-liblab-elements-textPrimary">Service Status</h4>
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm text-liblab-elements-textSecondary">
            ...
            <button
              ...
              className={classNames(
                ...
                'bg-liblab-elements-bg-depth-3 hover:bg-liblab-elements-bg-depth-4',
        ...
        <div className="p-4 bg-liblab-elements-bg-depth-2 rounded-lg">
          <h5 className="text-sm font-medium text-liblab-elements-textPrimary mb-2">Test API Key</h5>
          <div className="flex gap-2">
            <select
              ...
              className={classNames(
                ...
                'bg-liblab-elements-bg-depth-3 border border-liblab-elements-borderColor',
                'text-liblab-elements-textPrimary',
        ...
        {loading && serviceStatuses.length === 0 ? (
          <div className="text-center py-8 text-liblab-elements-textSecondary">Loading service statuses...</div>
        ) : (
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-liblab-elements-textPrimary">{service.provider}</h4>
                        <div className="space-y-1">
                          <p className="text-xs text-liblab-elements-textSecondary">
                            Last checked: {new Date(service.lastChecked).toLocaleTimeString()}
                          </p>
                          {service.responseTime && (
                            <p className="text-xs text-liblab-elements-textTertiary">
                              Response time: {Math.round(service.responseTime)}ms
                            </p>
                          )}
                          {service.message && (
                            <p className="text-xs text-liblab-elements-textTertiary">{service.message}</p>
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  {service.incidents && service.incidents.length > 0 && (
                    <div className="mt-2 border-t border-liblab-elements-borderColor pt-2">
                      <p className="text-xs font-medium text-liblab-elements-textSecondary mb-1">Recent Incidents:</p>
                      <ul className="text-xs text-liblab-elements-textTertiary space-y-1">
